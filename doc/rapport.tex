...
\lstinputlisting[inputpath=sources/, caption=Résultat sans Rotation (\lstname), label=resultat:resNR]{resNR_5x5.txt}
...
\lstinputlisting[inputpath=sources/, caption=Résultat avec Rotation (\lstname), label=resultat:resR]{resR_5x5.txt}
