...
\lstinputlisting[inputpath=sources/, caption=Code sans Rotation (\lstname), label=code:NoRotation]{code.ml}

\lstinputlisting[inputpath=sources/, caption=Code avec Rotation (\lstname), label=code:Rotation]{codeRotation.ml}

\lstinputlisting[inputpath=sources/, caption=Code avec Rotation et première tuile Locked (\lstname), label=code:RotationTileLocked]{codeRotation1stTileLocked.ml}

\lstinputlisting[inputpath=sources/, caption=Prototype Python (\lstname), label=code:Prototype]{proto.py}
