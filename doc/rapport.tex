...
Voici les temps observer pour un code sans rotation 

\subsection*{Affichage}

Voici un exemple de puzzle de taille 5 par 5 avec 5 couleurs résolu
par notre programme sans rotation :
\lstinputlisting[inputpath=sources/, caption=Affichage du résultat (sans rotation)(\lstname), label=res:5.5]{resNR_5x5.txt} 

Voici un exemple de puzzle de taille 5 par 5 avec 5 couleurs résolu
par notre programme avec rotation :
\lstinputlisting[inputpath=sources/, caption=Affichage du résultat (avec rotation)(\lstname), label=res:5.5]{resR_5x5.txt}
Comme dis lors de l'explication, nous obtenons tous les résultats dans 4 rotations possibles donc il faut diviser par 4 le nombre de résultat obtenus pour avoir le nombre réel de solutions possibles
